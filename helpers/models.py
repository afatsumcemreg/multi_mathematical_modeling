...
def box_plot_visualization(dataframe):
    # Create box plots
    fig = plt.figure(figsize=(12, 8))  # Adjusted figure size for better visibility
    sns.boxplot(
        data=dataframe[['biomass', 'biomass_pred', 'biomass_5%_increase', 'biomass_5%_decrease',
                        'product', 'product_pred', 'product_5%_increase', 'product_5%_decrease',
                        'sugar', 'sugar_pred', 'sugar_5%_increase', 'sugar_5%_decrease']],
        showmeans=True,
        meanprops={"marker": "o", "markerfacecolor": "white", "markeredgecolor": "black", "markersize": 6},
        orient='h'  # Set horizontal orientation
    )

    # plt.title('Box Plots for Fermentation Data')  # Corrected title setting
    plt.xlabel('Fermentation Data')  # X-axis represents data values now
    plt.ylabel('Variables')  # Y-axis represents variable names
    plt.subplots_adjust(hspace=0.3)
...
def sensitivity_analysis(dataframe):
    ...
    sensitivity_analysis_results = pd.DataFrame({
        ...
        'Substrate consumption': [ed_sugar_5_percent_increase, ed_sugar_5_percent_decrease, ID_sugar_increase, ID_sugar_decrease, IAD_sugar_increase, IAD_sugar_decrease]
    })
